...
def _get_api_config(
  ...
  if not team_name or not org_name:
      raise ValueError(
          "org_name and team_name variables must be set"
      )
  ...
  bearer_token = get_service_token(org_name, team_name, key_id, key_secret)  # Placeholder for actual token retrieval method

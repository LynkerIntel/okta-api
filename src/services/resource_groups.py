...
def get_resource_groups_by_team(bearer_token: str, org_name: str, team_name: str) -> List[Dict[str, Any]]:
  """
  Retrieve a list of resource groups for a given team using bearer token authentication.
...
def get_projects_by_resource_group(bearer_token: str, org_name: str, team_name: str, resource_group_id: str) -> List[Dict[str, Any]]:
  """
  Retrieve a list of projects for a given resource_group_id using bearer token authentication.
